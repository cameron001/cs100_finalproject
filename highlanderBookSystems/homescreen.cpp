...
void homeScreen::createWelcomeLabel()
{
    ...
    ui->welcomeLabel->setGeometry(x, y + 66, 150, 50);
}
...
void homeScreen::createExistingUserLoginButton()
{
    ...
    ui->existingUserLoginButton->setGeometry(x - 135, y + 300, 400, 25);
}
...
void homeScreen::createLastNameEdit()
{
    ...
    ui->lastNameLineEdit->setGeometry(x + 350, y + 150, 375, 35);
...
void homeScreen::createpasswordEdit()
{
    ...
    ui->passwordEdit->setGeometry(x + 350, y + 250, 375, 35);
    //start instantiation of dynamic button
...
void homeScreen::createDynamicButton()
{
    ...
    ui->dynamicButton->setGeometry(x + 25, y + 180, 100, 25);
}

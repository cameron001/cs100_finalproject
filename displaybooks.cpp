...
void DisplayBooks::onTableClicked(const QModelIndex &index)
{
    if (index.isValid()) {
           // QString cellText = index.data().toString();
            ...
            QString str="<table  cellpadding=\"3\" border=\"0\"   ><tr><td  ><b> Title: </b> "+QString::fromStdString(bk->getTitle())+"</td><td ><b> Author: </b>"+QString::fromStdString(bk->getAuthor())+"</td></tr><tr><td ><b> Publisher: </b>"+QString::fromStdString(bk->getPublisher())+"</td><td ><b> ISBN: </b>"+QString::fromStdString(bk->getIsbn())+"</td></tr><tr><td ><b> Rating: </b>"+QString::fromStdString(bk->getRating())+"</td><td ><b> Book Format: </b>"+QString::fromStdString(bk->getBookFormat())+"</td></tr><tr><td ><b> Number od Pages: </b>"+QString::number(bk->getePages())+"</td><td ><b> publish Date: </b>"+QString::fromStdString(bk->getPublishDate())+"</td></tr></table>";
